...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.addFilterBefore(jwtAuthenticationFilter, UsernamePasswordAuthenticationFilter.class)
                ...
                .antMatchers("/admin/**","/retrieveSpeaker/{idspeaker}","/updateSpeaker/{idspeaker}","/add","/addSpeaker","/retrieveallspeakers","/deleteSpeaker/{idspeaker}","/updateQuiz/{idquiz}","/deleteQuiz/{idquiz}","/addQuiz","/updateQuestion/{idquestion}","/DeleteQuestion/{idquestion}","/addQuestion","/addLessonToModule/{idmodule}/{lessonId}","/addBySpecialityAndLevel","/addBySpeciality","/DeleteModule/{idModule}","/updateModule/{idModule}","/addModule","/addLesson" , "/updateLesson/{idlesson}" , "/addClass","/DeleteLesson/{idlesson}","/retrieveLesson/{Lessonid}"  ,"/uploadContent","/updateclass/{idClass}","/retrieveClass/{classid}","/addComment","/retrieveallcomments","/updateComment/{idComment}","/DeleteComment/{idComment}","/retrieveComment/{commentid}","/addLessonBySpecialityAndLevel" ,"/addClass/{classId}/lessons" ,"/uploadContent","/DeleteClasse/{idClass}","/{classId}/addLesson","/addLessonByLevelAndSpeciality","/addEvent" ,"/updateEvent/{idevent}","/deleteEvent/{idevent}","/retrieveEvent/{idevent}","/search","/uploadEventPhoto/{eventId}").hasRole("ADMIN")

                .antMatchers("/teacher/**","/updateQuiz/{idquiz}","/deleteQuiz/{idquiz}","/addQuiz","/addQuestion","/DeleteQuestion/{idquestion}","/updateQuestion/{idquestion}","/addLessonToModule/{idmodule}/{lessonId}","/addBySpecialityAndLevel","/addBySpeciality","/updateModule/{idModule}","/DeleteModule/{idModule}","/addLesson","/addModule" , "/updateLesson/{idlesson}" , "/addClass","/DeleteLesson/{idlesson}","/retrieveLesson/{Lessonid}","/addLessonBySpecialityAndLevel" ,"/addClass/{classId}/lessons" ,"/uploadContent" ,"/DeleteClasse/{idClass}","/{classId}/addLesson","/addLessonByLevelAndSpeciality").hasRole("TEACHER")
